...
const pokemonDataResponse = {
  ...
  stats: [
    { base_stat: "45", effrort: "0", stat: { name: "hp" } },
    { base_stat: "49", effrort: "0", stat: { name: "attack" } },
    { base_stat: "49", effrort: "0", stat: { name: "defense" } },
    { base_stat: "65", effrort: "1", stat: { name: "special-attack" } },
    { base_stat: "65", effrort: "0", stat: { name: "special-defense" } },
    { base_stat: "45", effrort: "0", stat: { name: "speed" } },
  ],
};
...
export const handlers = [
    ...
    if (offset === "0") {
      ...
      return res(
        ...
        ctx.json({
          ...
          next: null,
          previous: null,
          results: getPokemonListResponse0,
        })
      );
    }
    if (offset === "20") {
      return res(
        ...
        ctx.json({
          ...
          results: getPokemonListResponse1,
        })
      );
    }
  }),
  ...
  rest.get("https://pokeapi.co/api/v2/pokemon/1/", (req, res, ctx) => {
    return res(ctx.json(pokemonDataResponse));
  }),
];
